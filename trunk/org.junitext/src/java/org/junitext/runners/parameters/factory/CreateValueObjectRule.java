 ...
 * </p>  
 * <p>
 * When the end tag is reached, the created object will be
 * popped. Note that this means that if you are going to do anything with value objects
 * created with this rule, it has to be done after this rules body text call is
 * made and BEFORE this rule's end method is called.  Thus the order in which
 * the rules are defined is very important for this rule to be effective. 
 * </p>
 * 
 * @author Jim Hurne
 * 
...
public class CreateValueObjectRule extends Rule {
	...
	/**
	 * Creates a new <code>CreateValueObjectRule</code> with the given
	 * type attribute name.
	 * 
	 * @param typeAttributeName the name of the attribute to get the value 
	 * objects type.
	 */
	...
	public void body(String namespace, String name, String bodyText) throws Exception {
		//Get defined value type, and the class object representing the value type
		...
		//Create the value object using the body text performing the necessary conversion
