 ...
 *
 */
public class DigesterParameterFactory implements
		ParameterFactory {
	...
	public List<Object[]> createParameters(Class<?> testClass, File xmlFile) throws Exception {
		...
		//We use the wildcard so that any bean tag at any nesting level is handled
		digester.addObjectCreate("*/bean", "java.lang.Object", "class");
		
		//Set the properties on the beans based on the <property name="" value="" > tag
		...
		SetPropertyWithParameterRule setPropertyWithObject = new SetPropertyWithParameterRule("name");
