...
/**
 * Passes the object on the top of the object stack 
 * to a setter on the next-to-top object on the stack.
 * The property that is set is based on the given attribute.
 * 
 * @author Jim Hurne
 */
public class SetPropertyWithParameterRule extends Rule {
	private static final String PROPERTY_NAME_STACK = "org.junitext.runners.parameters.factory.SetPropertyWithParameterRule.propertyNames";
	...
	public void begin(String namespace, String elementName, Attributes attributes) throws Exception {
		...
		//We use a stack because an instance variable would be reset on nested elements
		digester.push(PROPERTY_NAME_STACK, propertyName);
		
		//Push a single-element array onto the parameter stack to capture parameters
	...
	public void end(String arg0, String arg1) throws Exception {
		...
		if(parameters[0] != null) {
			...
			//Attempt to set the property on the parentBean using the given object
